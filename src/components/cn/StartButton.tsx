...
import stylesCn from "components/cn/StartButton.module.scss";
...
export const StartButton = ({
  ...
  const renderContent = () => {
    if (isFirstStatus) {
      ...
      if (elapsedTime < 0) {
        ...
        return (
          <div className={styles.flexContainer}>
            <p className={styles.text}>&quot;淬火效应&quot;启用中</p>
            <p className={styles.time}>
      ...
      return (
        <div
          className={`${styles.flexContainer} ${styles.gateOpen} ${stylesCn.gateOpen}`}
        >
          <p>可开启大门</p>
        </div>
      );
      ...
      if (elapsedTime < accelerateDecodingTime + claustrophobiaTime) {
        return (
          <>
            <div className={`${styles.flexContainer} ${styles.firstLine}`}>
              <p className={styles.text}>&quot;幽闭恐惧&quot;活跃</p>
              <p className={styles.time}>
                {accelerateDecodingTime + claustrophobiaTime - elapsedTime}
              </p>
            </div>
            <div className={`${styles.flexContainer} ${styles.secondLine}`}>
              <p className={styles.text}>&quot;拘留所&quot;活跃</p>
              <p className={styles.time}>
        ...
        return (
          <div className={styles.flexContainer}>
            <p className={styles.text}>&quot;拘留所&quot;不活跃</p>
          </div>
        );
      }
    }
