...
import { HunterSkillTimerButton } from "components/en/HunterSkillTimerButton";
import { DreamWitchSkillTimerButton } from "components/en/DreamWitchSkillTimerButton";
import styles from "components/HunterSkillTimer.module.scss";
import stylesEn from "components/en/HunterSkillTimer.module.scss";
...
export const HunterSkillTimer = ({
  ...
  if (hunterId === dreamWitchId) {
    ...
    return (
      <>
        <section className={`${styles.triple} ${stylesEn.triple}`}>
